    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        ...
        requireActivity().onBackPressedDispatcher.addCallback(viewLifecycleOwner) {
            when (viewModel.navState) {
                ...
                MainViewModel.NavState.CREATE_TO_AR_NEW -> findNavController().navigate(AugmentedRealityFragmentDirections.actionArFragmentToCreateFragment())
                MainViewModel.NavState.CREATE_TO_AR_REDO -> findNavController().navigate(AugmentedRealityFragmentDirections.actionArFragmentToCreateFragment())
                MainViewModel.NavState.MAPS_TO_AR -> findNavController().navigate(AugmentedRealityFragmentDirections.actionArFragmentToMapsFragment())
            }
        }
        return binding.root
    }
    ...
    private fun initUI() {
        ...
        binding.arButtonConfirm.setOnClickListener {
            if (appState == AppState.TARGET_PLACED) {
                ...
                findNavController().navigate(AugmentedRealityFragmentDirections.actionArFragmentToCreateFragment()) //always goes back to the Create Fragment, when being in edit mode
            } else {
